...
L["name"] = "名字"
L["same name already exists"] = "已存在同名法术"
L["spellid"] = "技能ID"
L["Remove"] = "删除声音"
L["Are you sure?"] = "确认删除？"
L["Test"] = "测试"
...
L["Throttle"] = "间隔"
L["The minimum interval of each alert"] = "控制法术语音警报之间的最小间隔"
L["Abilities"] = "技能"
L["Abilities options"] = "技能选项"
L["Disable options"] = "禁用技能模块"
L["Disable abilities by type"] = "技能各个模块禁用/启用选项"
...
L["Chech this will disable alert for spell being casted to friendly targets"] = "勾选此项将禁用敌方读条法术的通报"
...
L["BigHeal"] = "大型治疗法术"
L["BigHeal_Desc"] = "滋养 (" .. Classes.Druid .. ")|n治疗术 (" .. Classes.Priest .. ")|n真言术：耀 (" .. Classes.Priest .. ")|n圣光术 (" .. Classes.Paladin .. ")|n治疗波 (" .. Classes.Shaman .. ")|n升腾之雾 |cFF00FF96(" .. Classes.Monk ..")|r"
L["Resurrection"] = "复活技能"
