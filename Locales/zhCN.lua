...
L["CastingSuccess_Desc"] = "当敌对玩家施放群体控制技能于队友/盟友时，启用通用“成功”警报|n|n|cffC41F3B警告: 如果启用，以下所有技能都将警报，即使你有其中一些技能 |r|n|n旋风 (|cffFF7D0A德鲁伊|r)|n纠缠根须 (|cffFF7D0A德鲁伊|r)|n沉眠 (|cffFF7D0A德鲁伊|r)|n恐吓野兽 (|cffABD473猎人|r)|n变形术 (|cff69CCF0法师|r)|n冰霜之环 (|cff69CCF0法师|r)|n忏悔 (|cffF58CBA圣骑士|r)|n精神控制 (|cffFFFFFF牧师|r)|n妖术 (|cff0070DE萨满|r)|n恐惧 (|cff9482C9术士|r)"
...
L["FriendlyInterruptedDesc"] = "当敌人成功打断你或队友/盟友技能时，禁用警报。|n|n(播放暴雪“任务失败”音效。)"
