...
L["Evoker"] = "|cff33937F唤魔师|r"
L["DemonHunter"] = "|cffA330C9恶魔猎手|r"
L["Warlock"] = "|cff9482C9术士|r"
L["Buff Down"] = "敌方增益结束"
L["Spell Casting"] = "敌方读条技能"
L["BigHeal"] = "大型治疗技能"
L["BigHeal_Desc"] = "包含：滋养 （|cffFF7D0A德鲁伊|r）|n治疗术（|cffFFFFFF牧师|r）|n真言术：耀（|cffFFFFFF牧师|r）|n圣光术（|cffF58CBA圣骑士|r）|n治疗波（|cff0070DE萨满|r）|n升腾之雾（|cFF558A84武僧|r）"
L["Resurrection"] = "复活技能"
...
L["DPSDispel"] = "DPS驱散"
L["DPSDispel_Desc"] = "不是驱散魔法效果的混合职业驱散技能警报|n|n清除腐蚀（|cffFF7D0A德鲁伊|r）|n解除诅咒（|cff69CCF0法师|r）|n清创生血（|cFF558A84武僧|r）|n清毒术（|cffF58CBA圣骑士|r）|n净化疾病（|cffFFFFFF牧师|r）|n净化灵魂（|cff0070DE萨满|r）"
L["HealerDispel"] = "治疗驱散"
L["HealerDispel_Desc"] = "治疗职业（包含|cff9482C9术士|r）的通用驱散技能警报|n|n自然之愈（|cffFF7D0A德鲁伊|r）|n清创生血（|cFF558A84武僧|r）|n清洁术（|cffF58CBA圣骑士|r）|n纯净术（|cffFFFFFF牧师|r）|n净化灵魂（|cff0070DE萨满|r）|n烧灼驱魔（|cff9482C9术士|r）"
L["CastingSuccess"] = "控制类技能（预读）"
L["CastingSuccess_Desc"] = "当敌人预读施放控制类技能作用于您及您的队友时，启用通用 \"成功\"警报。|n|n|cffC41F3B警告: 如果启用了此功能，即使在法术列表中禁用了某些法术，下面的所有法术也会通报成功。|r|n|n旋风（|cffFF7D0A德鲁伊|r）|n纠缠根须（|cffFF7D0A德鲁伊|r）|n休眠（|cffFF7D0A德鲁伊|r）|n群体变形（|cff69CCF0法师|r）|n梦游（|cff33937F唤魔师|r）|n恐吓野兽（|cffABD473猎人|r）|n变形术（|cff69CCF0法师|r）|n冰霜之环（|cff69CCF0法师|r）|n忏悔（|cffF58CBA圣骑士|r）|n灼热凝视（|cffF58CBA圣骑士|r）|n精神控制（|cffFFFFFF牧师|r）|n妖术（|cff0070DE萨满|r）|n恐惧（|cff9482C9术士|r）"
L["DispelKickback"] = "驱散后惩罚"

L["Purge"] = "进攻驱散"
L["PurgeDesc"] = "驱散目标身上的魔法效果的通用警报，不包括奥术洪流。|n|n吞噬魔法（|cffA330C9恶魔猎手|r）|n宁神射击（|cffABD473猎人|r）|n驱散魔法（|cffFFFFFF牧师|r）|n强效净化术（|cff0070DE萨满|r）|n净化术（|cff0070DE萨满|r）|n吞噬魔法（|cff9482C9术士|r）"
...
L["Connected"] = "专精技能"
L["Connected_Desc"] = "当某些非常强大的需要施法时间法术成功完成施法时，会播放一个简单的连接提示。|n|n恶魔追击（|cffA330C9恶魔猎手|r）|n狙击（|cffABD473猎人|r）|n强效炎爆术（|cff69CCF0法师|r）|n圣光之怒（|cffFFFFFF牧师|r）|n控心术（|cffFFFFFF牧师|r）|n混乱之箭（|cff9482C9术士|r）"
...
L["GSA_EXPERIMENTAL_BUILD"] = "|cffC41F3B死亡骑士|r" .. "这是 GladiatorlosSA2 的实验版本，尚未在 TBC 上进行测试。虽然我确信一切运行正常，但如果遇到问题，请联系我，必要时可降级至 GSA2_TBC1.1。此消息将不会再显示。" .. "|r"
