...
L["World"] = "世界"
L["Alert works anywhere else then anena, BG, dungeon instance"] = "在世界中启用。"
L["Voice config"] = "语音设置"
L["Voice language"] = "语音类型"
L["Select language of the alert"] = "选择所有语音通报"
